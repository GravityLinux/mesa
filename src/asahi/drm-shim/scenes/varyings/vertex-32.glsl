...
v6=vec4(position.x,position.y,position.x*position.y,position.x*position.x+position.y*position.y+.3*position.x+.2*position.y)*0.218750000+vec4(.3,.4,.5,.6);
v7=vec4(position.x,position.y,position.x*position.y,position.x*position.x+position.y*position.y+.3*position.x+.2*position.y)*0.250000000+vec4(.3,.4,.5,.6);
}
