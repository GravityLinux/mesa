...
export T8132_GLES_SCISSOR=1
export T8132_GLES_VERTEX_SOURCE=$scene_dir/vertex.glsl
export T8132_GLES_FRAGMENT_SOURCE=$scene_dir/fragment.glsl
export T8132_GLES_WIDTH=${T8132_GLES_WIDTH:-512} T8132_GLES_HEIGHT=${T8132_GLES_HEIGHT:-512}
...
captures=7
[ -z "${T8132_SCISSOR_BOUNDARY:-}" ] || captures=9
python3 "$scene_dir/check.py" "$output_dir" "$T8132_GLES_WIDTH" "$T8132_GLES_HEIGHT" "$captures" "${T8132_SCISSOR_COLOR_ONLY:-0}"
