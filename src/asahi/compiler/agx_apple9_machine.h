...
enum agx_apple9_operand_role {
   ...
   AGX_APPLE9_OPERAND_SRC4,
   AGX_APPLE9_OPERAND_SRC5,
   AGX_APPLE9_OPERAND_SRC6,
   AGX_APPLE9_OPERAND_SRC7,
   AGX_APPLE9_OPERAND_SRC8,
   AGX_APPLE9_OPERAND_SRC9,
...
enum agx_apple9_dependency_layout {
   ...
   AGX_APPLE9_DEPENDENCY_MASK_61_63_77_79,
   AGX_APPLE9_DEPENDENCY_MASK_61_63_93_95,
};

#define AGX_APPLE9_MAX_ENCODING_OPERANDS 11
